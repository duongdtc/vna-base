...
// colors
export const ON_COLOR = ColorLight.primary500;
...
// ios
export const TRACK_WIDTH_IOS = 36;

export const THUMB_SIZE_IOS = 18;
...
export const ON_POSITION_IOS =
  TRACK_WIDTH_IOS - THUMB_SIZE_IOS - PADDING_IOS * 2;

export const BORDER_RADIUS_IOS = (THUMB_SIZE_IOS * 3) / 4;

// android
export const TRACK_WIDTH_ANDROID = 36;
